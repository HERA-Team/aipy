...
print "Generating aipy/__version__.py: ",
...
setup(name = 'aipy',
    ...
    package_dir = {'aipy':'aipy', 'aipy.optimize':'aipy/optimize', },#'aipy._src':'aipy/_src'},
    ...
    ext_modules = [
        ...
        Extension('aipy._alm',
            ['aipy/_healpix/alm_wrap.cpp', 
            'aipy/_healpix/cxx/Healpix_cxx/alm_map_tools.cc',
            'aipy/_healpix/cxx/libfftpack/ls_fft.c',
            'aipy/_healpix/cxx/libfftpack/bluestein.c',
            'aipy/_healpix/cxx/libfftpack/fftpack.c',
            'aipy/_healpix/cxx/Healpix_cxx/healpix_map.cc',
            'aipy/_healpix/cxx/Healpix_cxx/healpix_base.cc'],
            include_dirs = [numpy.get_include(), 'aipy/_healpix/cxx/cxxsupport',
                'aipy/_healpix/cxx/Healpix_cxx']),
        ...
        Extension('aipy._dsp', ['aipy/_dsp/dsp.c', 'aipy/_dsp/grid/grid.c'],
            include_dirs = [numpy.get_include(), 'aipy/_dsp', 'aipy/_dsp/grid']),
        Extension('aipy.utils', ['aipy/utils/utils.cpp'],
            include_dirs = [numpy.get_include()]),
        Extension('aipy._cephes',
            ['aipy/_cephes/_cephesmodule.c', 'aipy/_cephes/ufunc_extras.c'] + \
            glob.glob('aipy/_cephes/cephes/*.c') + \
            glob.glob('aipy/_cephes/c_misc/*.c'),
            include_dirs = [numpy.get_include()]),
    ],
    scripts=glob.glob('scripts/*'),
    #package_data = {'aipy': ['_aipy/*.txt']},
)
