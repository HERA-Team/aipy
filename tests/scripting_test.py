...
class TestParseAnts(unittest.TestCase):
    ...
    def testant4(self):
        ...
        cases = {
            ...
            'cross': [('auto',0,-1)],
            '0_1': [(ij2bl(0,1),1,-1)],
            '0_1,1_2': [(ij2bl(0,1),1,-1), (ij2bl(1,2),1,-1)],
            '(0,1)_2': [(ij2bl(0,2),1,-1), (ij2bl(1,2),1,-1)],
            '0_(1,2)': [(ij2bl(0,1),1,-1), (ij2bl(0,2),1,-1)],
            '(0,1)_(2,3)': [(ij2bl(0,2),1,-1), (ij2bl(0,3),1,-1),
                            (ij2bl(1,2),1,-1), (ij2bl(1,3),1,-1)],
            '0_(1,-2)': [(ij2bl(0,1),1,-1), (ij2bl(0,2),0,-1)],
            '0,1,all': [],
        }
        for i in range(nants):
            cases[str(i)] = map(lambda x: (ij2bl(x,i),1,-1), range(nants))
            cases['-'+str(i)] = map(lambda x: (ij2bl(x,i),0,-1), range(nants))
