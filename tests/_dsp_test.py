...
def test_testgrid2D_c():
    ...
    assert np.allclose(buf[10, 10], 0.63661977236758149 * np.exp(-2 * (0.1**2 + 0.1**2)), atol=1e-6)
    assert np.allclose(buf[14, 15], 0.63661977236758149 * np.exp(-2*(.5**2+.5**2)), atol=1e-6)
