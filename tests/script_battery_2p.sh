...
# Exercise lst.py
echo "Running: lst -C ex_cal_2p -j 2454555.5 > lst_out.txt"
lst -C ex_cal 2454555.5 | tee lst_out.txt

# Exercise mdlvis.py, create new.uv
echo "Running: mdlvis.py -C ex_cal_2p -s cyg --nchan=16 --sfreq=.1 --sdf=.001 --inttime=60 --startjd=2454555.5
--endjd=2454555.6 --pol=xx -m sim"
mdlvis.py -C ex_cal_2p -s cyg --nchan=16 --sfreq=.1 --sdf=.001 --inttime=60 --startjd=2454555.5 --endjd=2454555.6 --pol=yy -m sim
...
# Exercise plot_uv.py
plot_uv.py -p yy -a 0_1 -c 2_14 -x 2 -o plot_uv_out.png new.uv

# Exercise phs2src.py, create new.uv.cyg
echo "Running: phs2src.py -C ex_cal_2p -s cyg"
phs2src.py -C ex_cal_2p -s cyg new.uv
...
echo "Running: filter_src.py -C ex_cal_2p -s cyg -f 2 -d 2 --clean=1e-3 new.uvm"
filter_src.py -C ex_cal_2p -s cyg -r 2 -d 2 --clean=1e-3 new.uvr
...
echo "Running: flux_cal.py -C ex_cal_2p -s cyg -p -b -f new.uv"
...
mk_img.py -p yy -C ex_cal_2p -s cyg -o dim,dbm --fmt=out%d --altmin=30 new.uv
...
echo "Running: modmap.py -C ex_cal_2p -s cas,crab,vir -m modmap_out.fits -i mk_map_out.fits --dtype=float"
modmap.py -C ex_cal_2p -s cas,crab,vir -m modmap_out.fits -i mk_map_out.fits --dtype=float
